...
print(model.nettverk.state_dict()['0.bias'][0])
print(type( model.nettverk.state_dict()['0.bias'][0]))
print(len( model.nettverk.state_dict()['0.bias']))
print(model.nettverk.state_dict()['0.bias'][0].item())


print('__________________')
model2 = NN_model()

print(model2.nettverk.state_dict())
